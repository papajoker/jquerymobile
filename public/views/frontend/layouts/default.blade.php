	...
	<body>
		...
		<div data-role="panel" id="left-panel" data-theme="c">
			...
			<ul data-role="listview" data-theme="d">
				...
				@include('frontend.menuitem', array('menuitem_url'=>URL::to('about-us'),'menuitem_title'=>Lang::get('frontend/menu.about-us') ) )
				@include('frontend.menuitem', array('menuitem_url'=>URL::to('contact-us'),'menuitem_title'=>Lang::get('frontend/menu.contact-us') ) )				
